...
void __time_critical_func(pio_jtag_write_blocking)(const pio_jtag_inst_t *jtag, int *bsrc,int len,int *bdst) 
{      int byte_length = len;
       dma_init();
